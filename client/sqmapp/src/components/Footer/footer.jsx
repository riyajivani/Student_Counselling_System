          ...
          <Footer className='footer'>
               ...
               <div className='footer-icon'>
                    ...
                    {isStudent === "student" && <>
                         ...
                         <a href="/groupprofile" className='footer__link'><GroupsIcon /></a>
                         </Tooltip>

                         <Tooltip title="Ask Mentor" arrow={false}>
                              <a href="/askmentor" className='footer__link'><QuizIcon /></a>
                         </Tooltip>

                         <Tooltip title="Note" arrow={false}>
                              <a href="/note" className='footer__link'><EditNoteIcon /></a>
                         </Tooltip>
